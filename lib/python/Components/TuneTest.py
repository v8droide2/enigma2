...
class Tuner:
	...
	# transponder = (0:frequency 1:symbolrate 2:polarisation 3:fec 4:inversion 5:orbpos 6:system 7:modulation 8:rolloff 9:pilot 10:is_id 11:pls_mode 12:pls_code 13:t2mi_pid 14:plp_code 15:tsid 16:onid)
	def tune(self, transponder):
		if self.frontend:
			...
			if len(transponder) > 13:
				parm.t2mi_pid = transponder[13]
				parm.plp_id = transponder[14]
			else:
				parm.t2mi_pid = eDVBFrontendParametersSatellite.T2MI_Pid
				parm.plp_code = eDVBFrontendParametersSatellite.PLP_Code
...
class TuneTest:
	...
	# transponder = (0:frequency 1:symbolrate 2:polarisation 3:fec 4:inversion 5:orbpos 6:system 7:modulation 8:rolloff 9:pilot 10:is_id 11:pls_mode 12:pls_code 13:t2mi_pid 13:plp_code 15:tsid 16:onid)
